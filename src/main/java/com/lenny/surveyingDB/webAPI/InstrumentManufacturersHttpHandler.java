...
public class InstrumentManufacturersHttpHandler extends HandlerBase implements HttpHandler
{
    ...
    private void getInstrumentManufacturersRequest(HttpExchange httpExchange)
    {
        try
        {
            ...
            {
                IInstrumentManufacturer InstrumentManufacturer = InstrumentManufacturerAdapter.get(ConnectionManager.getInstance().getConnection(), Integer.parseInt(getRequestMap().get("ID").getValue()));
